...
namespace PediloOnline.Migrations
{
    ...
    [Migration("20241017181153_CambioenTablaCarritoyDetallecarrito")]
    partial class CambioenTablaCarritoyDetallecarrito
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PediloOnline.Models.Vendedor", b =>
                {
                    b.Property<int>("VendedorID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PediloOnline.Models.Vendedor", b =>
                {
                    b.HasOne("PediloOnline.Models.Localidad", "Localidad")
                        .WithMany("Vendedores")
                        .HasForeignKey("LocalidadID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
